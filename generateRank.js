...
const communityCards = [
    ...
    generateCard(suits.club, 9),
    generateCard(suits.heart, 9),
    generateCard(suits.spade, 9),
]

const holeCards = [
    generateCard(suits.club, 4),
    generateCard(suits.club, 6),
]
...
const player1 = [
    generateCard(suits.club, 12),
    generateCard(suits.club, 4),
    generateCard(suits.spade, 6),
    generateCard(suits.club, 14),
    generateCard(suits.diamond, 9),
    generateCard(suits.club, 2),
    generateCard(suits.club, 13)];
...
const player2 = [
    ...
    generateCard(suits.club, 14),
    generateCard(suits.diamond, 9),
    generateCard(suits.diamond, 12),
    generateCard(suits.club, 6)];

console.log(HandValueGenerate(cardsSort(communityCards, holeCards)))